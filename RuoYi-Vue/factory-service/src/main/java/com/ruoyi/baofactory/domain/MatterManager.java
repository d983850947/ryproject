...
/**
 * 物料管理对象 matter_manager
 * 
 * @author ruoyi
 * @date 2021-01-27
 */
public class MatterManager extends BaseEntity
{
    ...
    public void setFashionEditor(String fashionEditor) 
    {
        this.fashionEditor = fashionEditor;
    }

    public String getFashionEditor() 
    {
        return fashionEditor;
    }
    public void setCuttingTable(String cuttingTable) 
    {
        this.cuttingTable = cuttingTable;
    }

    public String getCuttingTable() 
    {
        return cuttingTable;
    }
